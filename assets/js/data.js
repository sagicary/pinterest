	...
	for (var x=0; x<20; x++){
		...
		$('#columnas').append('<div class="pin col-md-12" type="button" data-toggle="modal" data-target="#myModal'+datos[x].id+'"><img class="img-responsive img-rounded" src="dist/img/'+
			...
			datos[x].hashtag+'</p></div>'+
			    ...
			    '<h4 class="modal-title" id="myModalLabel'+datos[x].id+'">'+datos[x].title+'</h4></div>'+
				'<div class="modal-body"><img class="img-responsive img-rounded center-block" src="dist/img/'+datos[x].image_url+'"></div><div class="modal-footer">'+
				...
				'<div class="text-left segundo"><h5><i class="fa fa-user-circle" aria-hidden="true"></i>'+datos[x].username+' #'+datos[x].hashtag+
				'<button type="button" class="btn btn-default" data-dismiss="modal">Leerlo</button></h5></div><h4 class="text-justify">'+datos[x].description+
				'</h4></div></div></div></div>');
}
...
datos.forEach(function(el){
	...
	//console.log(el.image_url);
	//if(el<=20){
		$('#mostrar').append('<div class="col-md-2" type="button" data-toggle="modal" data-target="#myModal'+el.id+'"><img class="img-responsive" src="dist/img/'+
		...
		el.hashtag+'</p></div><div class="modal fade" id="myModal'+el.id+'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">'+
			...
			'<div class="modal-body"><img class="img-responsive img-rounded center-block" src="dist/img/'+el.image_url+'"></div><div class="modal-footer">'+
			'<div class="headermodal"><i class="fa fa-upload" aria-hidden="true"></i><i class="fa fa-check" aria-hidden="true"></i>'+
			'<i class="fa fa-ellipsis-h" aria-hidden="true"></i><button type="button" class="btn btn-primary"><i class="fa fa-thumb-tack" aria-hidden="true"></i>Guardar</button></div>'+
			'<div class="text-left segundo"><h5><i class="fa fa-user-circle" aria-hidden="true"></i>'+el.username+' #'+el.hashtag+
			'<button type="button" class="btn btn-default" data-dismiss="modal">Leerlo</button></h5></div><h4 class="text-justify">'+el.description+
			'</h4></div></div></div></div>');
	//}
});
*/
